...
cat(svg.string.plot, file = "../../emotions_dashboard/data/influence_participants_lmer_method_uw_students.txt")
dev.off()
...
cat(svg.string.plot, file = "../../emotions_dashboard/data/leverage_datapoints_lmer_method_uw_students.txt")
dev.off()
...
cat(svg.string.plot, file = "../../emotions_dashboard/data/leverage_participants_lmer_method_uw_students.txt")
dev.off()
...
cat(svg.string.plot, file = "lmer_output/web_freq_method_boxplot_uw_students_re.txt")
cat(svg.string.plot, file = "../../emotions_dashboard/data/web_freq_method_boxplot_uw_students_re.txt")

dev.off()


ggsave('accuracy-charts/web_freq_method_boxplot_uw_students_re.png', width = 8, height = 4)

################
#  model summary

tab_model(m3, file = "lmer_output/lmer_summary_method_ranking_uw_students_re.html")
tab_model(m3, file = "../../emotions_dashboard/data/lmer_summary_method_ranking_uw_students_re.html")
...
cat(aov.apa.re, file = "lmer_output/anova_lmer_method_ranking_free_uw_students_re.html")
cat(aov.apa.re, file = "../../emotions_dashboard/data/anova_lmer_method_ranking_free_uw_students_re.html")
...
cat(svg.string.plot, file = "lmer_output/web_freq_method_uw_students_re.txt")
cat(svg.string.plot, file = "../../emotions_dashboard/data/web_freq_method_uw_students_re.txt")
